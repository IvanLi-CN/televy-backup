on run argv
    ...
    tell application "Finder"
        ...
        set payload to "{" & q & "app_name" & q & ":" & q & "TelevyBackup.app" & q & "," & q & "applications_name" & q & ":" & q & "Applications" & q & "," & q & "app_position" & q & ":[" & (item 1 of appPosition) & "," & (item 2 of appPosition) & "]," & q & "applications_position" & q & ":[" & (item 1 of applicationsPosition) & "," & (item 2 of applicationsPosition) & "]," & q & "drag_direction" & q & ":" & q & direction & q & "," & q & "window_id" & q & ":" & windowID & "," & q & "window_role" & q & ":" & q & "Finder" & q & "}"
    end tell
