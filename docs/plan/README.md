...
| fn4ny | Settings：配置整包导出/导入（keyed config bundle） | 已完成 | `fn4ny:config-bundle-export-import/PLAN.md` | 2026-02-04 | 实现分支：`feat/fn4ny-config-bundle-export-import`；待主人验收 |
