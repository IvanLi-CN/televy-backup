...
| 3ejpg | macOS：dev app variant（bundle id/name + menubar DEV 徽标） | 部分完成（2/3） | `3ejpg:macos-dev-app-variant/PLAN.md` | 2026-02-08 | 实现分支：`feat/3ejpg-macos-dev-app-variant` |
