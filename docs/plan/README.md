...
| 0005 | 设置窗口独立化与多备份目录（多 Telegram Endpoint + 金钥恢复） | 待实现 | `0005:multi-backup-directories-keyed-restore/PLAN.md` | 2026-01-21 | 已冻结：每目录 1 份 Bot 信息（可复用 `endpoint_id`）+ pinned bootstrap/catalog + per-target schedule（继承全局）+ TBK1 金钥；UI 需对齐现有视觉 |
