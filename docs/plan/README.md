...
| 7r6p4 | 后台备份吞吐自适应优化（稳定优先，尽量跑满带宽） | 部分完成（4/5） | `7r6p4:background-backup-adaptive-throughput/PLAN.md` | 2026-02-24 | PR #46；完整 30 分钟复测（opt9）`>=1 MiB/s` 累计 20.62 分钟，已达验收；待新提交 CI/review 收敛后收口 |
