...
| nvr79 | 开发期绕过 Keychain（codesign + vault key；daemon-only） | 部分完成（1/4） | `nvr79:avoid-keychain-in-dev/PLAN.md` | 2026-01-28 | 已冻结：`TELEVYBACKUP_DISABLE_KEYCHAIN` + `vault.key` + daemon control IPC |
