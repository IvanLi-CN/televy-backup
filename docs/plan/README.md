...
| 7r6p4 | 后台备份吞吐自适应优化（稳定优先，尽量跑满带宽） | 部分完成（4/5） | `7r6p4:background-backup-adaptive-throughput/PLAN.md` | 2026-02-24 | PR #46；新增 pack entries 扩容 + base snapshot file_chunks 复用；现场快检仍未达标 |
