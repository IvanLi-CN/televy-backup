...
| g7gt3 | 支持 `.televyignore` 的文件/目录忽略能力 | 已完成 | `g7gt3-televyignore-target-ignore/SPEC.md` | 2026-03-05 | core 扫描/quick stats 已支持 `.televyignore`；run.finish 输出 ignore 汇总字段；macOS 主界面显示 ignore 状态；review-loop 已补齐容错与计数回归 |
