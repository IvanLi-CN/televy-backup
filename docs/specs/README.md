...
| zx5n2 | Release 失败 Telegram 告警接入 | 已完成 | `zx5n2-release-failure-telegram-alerts/SPEC.md` | 2026-09-01 | pinned Oidrune notifier、caller-owned summary、OIDC permission、workflow contract tests |
|-----:|-------|--------|------|------|-------|
...
| 备份快照详情检查 | active | implemented | `backup-snapshot-inspection/SPEC.md` | - |
