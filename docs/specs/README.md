...
|-----:|-------|--------|------|------|-------|
| n2kbu | PR + Label 发布能力 | 已完成 | `n2kbu-pr-label-release/SPEC.md` | 2026-03-07 | 已补 backfill ancestry、tag 并发幂等、release 串行与 frozen intent artifact；待 PR checks 与 review-loop 收敛 |
