...
- failure summary 使用 resolver 输出的 target SHA、ref、actor、run attempt、run URL 和解析详情；smoke summary 使用 dispatch SHA、当前 run URL、ref、actor、run attempt 和 smoke 说明。
