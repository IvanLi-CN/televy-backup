...
- nested helper component lock, SHA-256/CDHash/designated-requirement comparison (including
  architecture-independent canonicalization of the `codesign` `# ` marker and commutative CDHash
  alternatives), legacy artifact-digest compatibility, and RC artifact reuse inspection
