...
> Canonical topic spec migrated from `docs/plan/0008:status-popup-file-logging/PLAN.md`.
...
- 后端每轮同步日志（NDJSON）契约：`docs/specs/sync-logging-durability/contracts/file-formats.md`
