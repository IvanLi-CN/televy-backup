# 统一进度条规范（含 Prepare 并行）与四处 UI 对齐
...
- canonical 资源索引：`docs/specs/README.md`
- 历史相关主题：
  - `docs/specs/status-popover-dashboard/SPEC.md`
  - `docs/specs/remote-first-index-sync/SPEC.md`
  - `docs/specs/events-live-task-ui/SPEC.md`
